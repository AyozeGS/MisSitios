...
export class Tab1Page implements OnInit {
  ...
  map: L.Map;
  center: L.PointTuple;
  miMarker: L.icon = L.icon(
    {
      iconUrl: 'assets/img/ico_estoy_aqui.png',
      iconSize: [48, 48], iconAnchor: [24, 43]
    });
  ...
  async initMap() {
    ...
    this.center = [this.position.coords.latitude,
    ...
    setTimeout(() => {
      ...
      L.marker(this.center,
        { icon: this.miMarker }).addTo(this.map);
    });
  }
